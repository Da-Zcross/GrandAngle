            ...
            <div class="window_info_left">
                ...
                <div class="inp_image">
                    ...
                    <span class="img-preview">
                        ...
                        <img id="preview-photo" src="<?= $artiste['chemin_image'] ?>" alt="Preview Photo"
                ...
                <div class="inp_date">
                    ...
                    <input type="date" name="date_realisation" id="date_oeuvre"
                        placeholder="Date de réalisation de l'oeuvre" required>
                </div>

                <div class="inp_date_livraison_prevu">
                    <label for="date_livraison_prevu_oeuvre" class="date_livraison_prevu_oeuvre" required>Date de
                        livraison
                        prévu *</label>
