...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["modifier"])) {
    ...
    try {
        $sql = "UPDATE oeuvres_expo SET nom_oeuvre = :nom_oeuvre, description_oeuvre = :description_oeuvre, date_realisation = :date_realisation, largeur = :largeur, hauteur = :hauteur, profondeur = :profondeur, date_livraison_prevu = :date_livraison_prevu, date_livraison_reel = :date_livraison_reel, id_type_oeuvre = :id_type_oeuvre, id_theme = :id_theme WHERE id_oeuvres = :id_oeuvres";
