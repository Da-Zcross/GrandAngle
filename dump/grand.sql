...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 22 mars 2024 à 15:58
...
(6, 'David', 'Sara', 'sarah.davis@example.com', '45 Rue du loup ', 87654, 'Sometown', '1234', 'Technicien en installation', 6),
...
(10, '2024-03-18', '2024-03-18', '19:07:00', 10, 'CHEMIER', 'Luc', 'dazcrosse@gmail.com', 12, 'Black ', 12),
(23, '2024-03-23', '2024-03-26', '00:05:00', 10, 'CHEMIER', 'Luci', 'dazcrosse@gmail.com', 17, 'L\'Évolution de la Sculpture', 16),
(33, '2024-03-21', '2024-03-29', '05:09:00', 12, 'CHEMIER', 'Luca', 'dazcrosse@gmail.com', 15, 'Black Fish', 6),
(34, '2024-03-13', '2024-03-31', '05:14:00', 8, 'CHEMIER', 'Lucae', 'dazcrosse@gmail.com', 14, 'L\'Évolution ', 14),
(37, '2024-03-19', '2024-03-21', '12:00:00', 0, 'DIAKE', 'Noha', 'diake@gmail.com', 8, 'Redmi', 5);
...
CREATE TABLE `oeuvres_expo` (
  ...
  `chemin_qr` varchar(25) DEFAULT NULL,
...
INSERT INTO `oeuvres_expo` (`id_oeuvres`, `nom_oeuvre`, `chemin_image`, `chemin_qr`, `description_oeuvre`, `date_realisation`, `nombre_vues`, `largeur`, `hauteur`, `profondeur`, `poids`, `duree`, `date_livraison_prevu`, `date_livraison_reel`, `id_type_oeuvre`, `id_theme`, `id_artiste`, `id_expo`, `id_plan`) VALUES
(4, 'La Grande Vague de Kanagawa', 'images/grande_vague_kanagawa.jpg', 'imagesQrcode/65fd8979d534', 'La Grande Vague de Kanagawa est une estampe japonaise de l\'artiste Hokusai, réalisée vers 1830.', '1830-01-01', 900000, 0.00, 0.00, 0.00, '', NULL, '2024-04-18', '2024-04-22', 3, 7, 4, 23, NULL),
(5, 'Le Déjeuner sur l\'herbe', NULL, NULL, 'Le Déjeuner sur l\'herbe est une peinture de l\'artiste français Édouard Manet, réalisée en 1863.', '1863-01-01', 750000, 0.00, 0.00, 0.00, '', NULL, '2024-04-02', '2024-04-15', 1, 8, 18, 33, NULL),
(6, 'Les Tournesols', 'images/tournesols.jpg', NULL, 'Les Tournesols est une série de tableaux de Vincent van Gogh, peints en 1888.', '1888-01-01', 850000, NULL, NULL, NULL, NULL, NULL, '2024-04-11', '2024-04-18', 1, 9, 6, 34, NULL),
(7, 'La Nuit étoilée', 'images/nuit_etoilee.jpg', NULL, 'La Nuit étoilée est une peinture de Vincent van Gogh, réalisée en 1889.', '1889-01-01', 950000, NULL, NULL, NULL, NULL, NULL, '1889-01-01', NULL, 1, 10, 9, 35, NULL),
(8, 'La Danseuse au bouquet', 'images/danseuse_bouquet.jpg', NULL, 'La Danseuse au bouquet est une sculpture de Camille Claudel, réalisée en 1884.', '1884-01-01', 780000, NULL, NULL, NULL, NULL, NULL, '1884-01-01', NULL, 2, 11, 13, 37, NULL),
(9, 'La Grande Arche de la Défense', 'images/grande_arche_defense.jpg', NULL, 'La Grande Arche de la Défense est une monumentale arche située à Paris.', '1989-01-01', 600000, 108.00, 110.00, 24.00, NULL, NULL, '1989-01-01', NULL, 4, 12, 0, NULL, NULL),
(10, 'La Pyramide du Louvre', 'images/pyramide_louvre.jpg', NULL, 'La Pyramide du Louvre est une pyramide de verre et de métal située au centre de la cour Napoléon du musée du Louvre à Paris.', '1989-01-01', 700000, NULL, NULL, NULL, NULL, NULL, '1989-01-01', NULL, 4, 13, 0, NULL, NULL),
(11, 'La Liberté guidant le peuple', 'images/liberte_guidant_peuple.jpg', NULL, 'La Liberté guidant le peuple est une peinture d\'Eugène Delacroix, réalisée en 1830.', '1830-01-01', 850000, NULL, NULL, NULL, NULL, NULL, '1830-01-01', NULL, 1, 14, 0, NULL, NULL),
(12, 'La Guernica', 'images/guernica.jpg', NULL, 'La Guernica est une peinture de Pablo Picasso, réalisée en 1937.', '1937-01-01', 900000, NULL, NULL, NULL, NULL, NULL, '1937-01-01', NULL, 1, 15, 0, NULL, NULL),
(13, 'La Tour Eiffel', 'images/tour_eiffel.jpg', NULL, 'La Tour Eiffel est une tour de fer puddlé de 324 mètres de hauteur située à Paris.', '1889-01-01', 1000000, NULL, NULL, NULL, NULL, NULL, '1889-01-01', NULL, 4, 16, 0, NULL, NULL),
(14, 'Le Radeau de la Méduse', 'images/radeau_meduse.jpg', NULL, 'Le Radeau de la Méduse est un tableau de Théodore Géricault, réalisé en 1819.', '1819-01-01', 950000, NULL, NULL, NULL, NULL, NULL, '1819-01-01', NULL, 1, 12, 0, NULL, NULL),
(24, 'soukou', './assets/images/ecran.png', NULL, 'caz', '2024-03-21', NULL, 12.00, 12.00, 21.00, '6 kg', NULL, '2024-03-23', '2024-03-23', 6, 5, 5, NULL, NULL),
(27, 'TAOUKIO', './assets/images/black.jpg', 'imagesQrcode/65fd898f8587', 'CACEV', '2024-03-14', NULL, 12.00, 12.00, 21.00, '6 kg', NULL, '2024-03-21', '2024-03-13', 4, 6, 6, NULL, NULL);
...
ALTER TABLE `oeuvres_expo`
  ...
  ADD UNIQUE KEY `id_expo` (`id_expo`),
...
--
ALTER TABLE `artiste`
  MODIFY `id_artiste` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `exposition`
  MODIFY `id_expo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `oeuvres_expo`
  MODIFY `id_oeuvres` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
